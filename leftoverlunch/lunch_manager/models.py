...
class MenuItem(models.Model):
    ...
    allergy = models.ManyToManyField('Allergy', related_name='items', help_text='Select the allergies for this item (if any, Max. 5)')
    ...
    category = models.ManyToManyField('Category', related_name='items', help_text='Select the categories for this item')
